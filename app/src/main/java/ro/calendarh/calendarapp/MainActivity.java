...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView todayActivity = (TextView)findViewById(R.id.todayActivity);
        todayActivity.setText("“If you spend your whole life waiting for the storm, you’ll never enjoy the sunshine.” -Morris West");
    }
